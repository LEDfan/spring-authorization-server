 ...
 */
public abstract class BaseAuthorizationCodeAuthenticationProvider implements AuthenticationProvider {
	 ...
	 */
	public BaseAuthorizationCodeAuthenticationProvider(OAuth2AuthorizationService authorizationService, JwtEncoder jwtEncoder) {
	...
	protected  Authentication authenticate(Authentication authentication,
			...
			OAuth2Authorization.Token<? extends AbstractOAuth2Token> authorizationCode) throws AuthenticationException {
